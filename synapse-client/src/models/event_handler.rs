...
pub struct EventHandler {
    ...
    #[serde(rename = "id")]
    pub id: String,
    /// Unique identifier of a synapse instance
    #[serde(rename = "synapseInstanceId", skip_serializing_if = "Option::is_none")]
    pub synapse_instance_id: Option<String>,
    #[serde(rename = "names")]
...
impl EventHandler {
    /// Event handler
    pub fn new(id: String, names: Vec<String>, endpoint: String) -> EventHandler {
        EventHandler {
            id,
            synapse_instance_id: None,
            names,
            endpoint,
            endpoint_type: None,

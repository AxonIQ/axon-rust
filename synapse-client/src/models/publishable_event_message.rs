...
/// PublishableEventMessage : Publishable event message



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PublishableEventMessage {
...
impl PublishableEventMessage {
    /// Publishable event message
    pub fn new(name: String) -> PublishableEventMessage {
